  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, (currentUser) => {
      ...
      if(currentUser?.email){
        ...
        axios.post('https://job-task-server-pied.vercel.app/jwt' ,user ,{withCredentials: true})
         .then(res => console.log( 'login token',res.data))
          //  setLoading(false);
      }else {
        axios.post('https://job-task-server-pied.vercel.app/logout', {}, { withCredentials: true })
            .then(res => {
